...
const SameCategory = ({AllFilterProject,SendNumber}) => {
  ...
  return (
    <div className="product-container grid grid-cols-5 gap-8 max-w-full items-center justify-center  
    ...
    ">
      {AllFilterProject &&
        AllFilterProject.slice(0, displayedProducts).map((product) => (
          <div className="product max-w-full
          ...
          " key={product._id}>
            ...
            className="category-1 r">
              ...
              " >
                <img src={urlFor(product.image)} alt="" onClick={() => viewProduct(product._id,product)}
              ...
              h-[200px]  x480:h-[170px] x392:h-[170px] x300:h-[170px]
               pl-2 pr-2 " onClick={() => viewProduct(product._id,product)}>
